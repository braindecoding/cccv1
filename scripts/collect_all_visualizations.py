...
def collect_visualizations():
    ...
    for dataset in datasets:
        ...
        for folder in cv_folders:
            ...
            dataset_files = list(folder.glob(f"*{dataset}*.png"))
    ...
    for folder in cv_folders:
        summary_files = list(folder.glob("*summary*.png"))
...
"""
    ...
    for dataset in datasets:
        file_path = collection_dir / f"cv_model_reconstruction_{dataset}.png"
        if file_path.exists():
            index_content += f"- `cv_model_reconstruction_{dataset}.png` - {dataset.title()} reconstruction visualization\n"
